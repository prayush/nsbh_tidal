...
psd=ppsd.from_txt('/home/p/pfeiffer/prayush/advLIGO_PSDs/ZERO_DET_high_P.dat',\
                          N/2+1, delta_f, low_freq_cutoff=f_lower-2.)

for idx in range(Nsims):
  random_match( sample_rate=sample_rate, time_length=time_length, \
                mNS=1.35, \
                Qmin=2, \
                Qmax=5, \
                smin=-0.5, \
                smax=+0.75, \
                tLambda=500., \
                f_lower=f_lower, psd=psd, outfile=outfile)
