...
% \textbf{Multiple identical sources at low SNR: }
\label{s2:identical_multiple}
% 
...
of optimally oriented sources, it is valid more generally if the population is
...
proportional to the $D_\mathrm{eff}^3$}~\cite{Markakis:2010mp}. However, it 
