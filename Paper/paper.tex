...
the GW amplitude model for NSBHs, but it needs to be augmented with a compatible
phase model. However, we expect the combined effect of modeling errors to not
