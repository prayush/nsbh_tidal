...
and in binary neutrons (BNS)~\cite{Hulse:1975uf,Taylor:1982wi,
...
in literature, which often sample from more astrophysically informed population
distribution functions~\cite{Mandel:2009pc}.
