...
band of the LIGO observatories, and are therefore their primary targets.
Neutron star black hole binaries form a physically distinct sub-class of
compact binaries, that we expect to detect the first of in the upcoming
observing runs~\cite{Abbott:2016ymx}. And when the detectors reach their design
sensitivity, we can expect to detect NSBHs at a healthy rate of $0.2-300$
mergers a year~\cite{Abadie:2010cf}.

\prayush{\bf Why NSBHs? 1. GRB, 2. tidal measurements.}


\prayush{\bf what we do in this paper - brief summary}


\prayush{\bf Sec 3 summary}
