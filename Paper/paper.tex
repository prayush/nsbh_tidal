...
\begin{figure*}
\centering    
\includegraphics[width=2.1\columnwidth]{plots-TT/TTLambdaCIWidths68_3_Lambda_SNR.png}\\
\includegraphics[width=2.1\columnwidth]{plots-TT/TTLambdaCIWidths90_0_Lambda_SNR.png}
\caption{This figure shows.}
