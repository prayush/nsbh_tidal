...
%
In this paper, we present the first fully Bayesian study of the measurability 
of neutron star (NS) tidal deformability $\lambdans\propto (R/M)_\mathrm{NS}^{5}$ from NSBH
observation(s), where we
take into account the crucial effect of BH spins as well.
% 
...
% initial-LIGO over its entire coincident operation period. 
...
% 
During O1, aLIGO made the first terrestrial observation of gravitational 
waves~\cite{LIGOVirgo2016a}. Emitted by a pair of coalescing black holes, these
waves
heralded an era of observational GW astrophysics as they traveled through Earth.
% 
By $2018-19$, we expect the aLIGO instruments to reach their design
sensitivity, at which point we may expect to observe $\sim 70$ binary mergers a
year~\cite{Abadie:2010cf}.


Coalescing binaries of compact objects, i.e. black holes (BH) and/or
neutron stars (NS) are the primary target sources for 
aLIGO~\cite{Abbott:2016nhf}. An important sub-class of these sources are NSBH
binaries, of which we expect $\mathcal{O}(10)$ GW observations every 
year~\cite{Abadie:2010cf}.
...
production of relativistic jets~\cite{Foucart2015,
...
BBH)~\cite{Kyutoku:2010zd,Lackey:2013axa,Lovelace:2013vma,Foucart2015,
Pannarale:2015jia}.
...
Sec.~\ref{s1:multiple_observations}. In addition, we probe two paradigms, one
