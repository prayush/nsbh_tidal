...
% 
Contours are drawn in each panel demarcating regions where we can constrain the
...
\begin{figure*}
\centering    
\includegraphics[trim={0 0 0 2cm}, width=0.95\columnwidth]{plots/TTSNRThresholdFor200LambdaMeasurement_BHspin_BHmass_Lambda1500_0_CI90_0.pdf}
\includegraphics[width=0.95\columnwidth]{plots/TTSNRThresholdFor100LambdaMeasurement_BHspin_BHmass_Lambda1500_0_CI90_0.pdf}
