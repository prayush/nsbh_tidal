...
\red{SAY HERE THAT WE ONLY USE THE $l=|m|=2$ modes.}
\prayush{
This is possible because of our simplification of 
...
$\lambdans$ values will be within $10\%$ of the real value after about
$20$ events for less deformable neutron stars with $\lambdans\leq 1000$,
and in as few as $10$ events for more deformable stars with
$\lambdans\geq 1500$.
% 
The results discussed in Fig.~\ref{fig:TT_Lambda_vs_N_L800_CI90_0},
\ref{fig:TT_Lambda_vs_N_CI90_0} and the left panel
of Fig.~\ref{fig:TT_LambdaMedian_vs_N_AllInOne} all apply to the parameter distribution spanned by 
the grid G. This distribution has $\mbh$ as low as $2.7M_\odot$ (i.e. $q=2$).
...
the scenario where no black hole masses fall within the mass gap.}
