...
% % \includegraphics[width=0.67\columnwidth]{plots/TNEtaBiasesOverCIWidthsVsSNR_Lambda800_CI90_0}
...
% % \includegraphics[width=0.67\columnwidth]{plots/TNChiBHBiasesOverCIWidthsVsSNR_Lambda800_CI90_0}
...
mergers.
% 
These results show that our probed subset of disruptive NSBH mergers is as
informative of NS tidal properties as are BNS populations, if we assume a uniform mass
distribution for NSs and zero NS spins, and possibly better if NS masses are
not distributed uniformly in astrophysical binaries~\cite{Agathos:2015a}.
