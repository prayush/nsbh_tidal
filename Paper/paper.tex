...
threshold at which a source is considered detectable~\footnote{which
...
\end{align}
% 
where $N_i$ is the number of sources within the $i-$th shell (such that
$N:=\sum N_i$), and $n$ is the number density of source distribution in volume.
% 
