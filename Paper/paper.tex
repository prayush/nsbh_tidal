...
which the $90\%$ confidence intervals for $\lambdans$ lie, for $90\%$ of 
...
$\lambdans$ confidence intervals will require $40+$ events.
}
\label{fig:TT_LambdaError_vs_N_L500_2000_CI90_0_AllInOne}
\end{figure*}
% 
...
we construct
its $90\%$ confidence interval $[{\lambdans^{90\%}}_{i-},{\lambdans^{90\%}}_{i+}]$.
...
conservative width $|Y^+ - X^-|$ that contains the $90\%$ confidence
...
confidence intervals towards the left edge to $90\%$ of $4000$, i.e. $3600$.
% 
