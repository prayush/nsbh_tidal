...
neutron stars. The Tolman-Oppenheimer-Volkoff equation would then predict that all
NSs lie on a universal $\lambdans$ versus $\mns$ curve. As the final part of
...
\prayush{INSERT TEXT ON LIMITATIONS}
