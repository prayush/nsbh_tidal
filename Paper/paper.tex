...
sufficiently to power short gamma-ray bursts (SGRB)~\cite{}.
...
% 
We use the LEA+ model to produce tidal waveforms that incorporate the effect
...
\chibh=\{-0.5, 0, 0.5, 0.75\}$ and $\lambdans=\{500,1000,1500,2000\}$.
...
signals. In the worst case, when the BH mass is within the astrophysical mass-gap
...
``mass-gap''~\cite{Bailyn:1997xt,Kalogera:1996ci,Kreidberg:2012,
Littenberg:2015tpa}), and the
