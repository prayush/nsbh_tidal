...
$\rho\geq 30$, and $0.04-1$ a year with $\rho\geq 70$. Therefore, our injection
parameters span a physically interesting subset of NSBH binaries, that is
{\it also} likely observable in the near future. 
...
the {\it true} and the {\it measured} (i.e. median) values of $\eta$ are marked.
The effect of ignoring tidal
...
$|\arr_X| < 1$ can we ignore tidal effects in our templates
...
% 
In addition, we also notice that, unlike for $\mchirp$, the measured value of
