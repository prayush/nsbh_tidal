...
% 
In both cases, we find that it is the loudest $5-10$ events that provide
...
templates).
%In addition, we also maximize over coalescence time and phase.
...
the tidal deformation of the NS drains energy from the orbit faster than in
the BBH case, and the disruption of NS close to merger reduces GW signal
power at high frequencies. Both of these effects make the resulting signal
resemble a BBH signal of higher chirp mass.
...
% \includegraphics[trim={3cm 0 0 0},width=2.\columnwidth]{TTLambdaCIWidths90_0_Lambda_SNR.pdf}
...
% \includegraphics[width=1.025\columnwidth]{TTSNRThresholdFor100LambdaMeasurement_BHspin_BHmass_Lambda2000_0_CI90_0}\\
\caption{
...
NSBH detections of aLIGO detectors. This result is especially encouraging
to NR follow-up efforts for GW detections, as we now know that only a handful
of loudest NSBH events will merit full numerical-GR follow-up simulations.
...
detector operation.
% 
We also find that, within this population, the loudest $\sim 5-10$ events
will provide us with most of the tidal information, and will therefore
merit full NR follow-up.
% 
