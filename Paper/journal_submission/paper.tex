...
with the difference
that events in each population have been sorted according to their
signal strength (SNR). We note that information about
...
over the NSBH parameter space, and show the results in Fig.~\ref{
fig:PhenomC_vs_SEOBNRv2_LEA}. We restrict the comparison to frequencies
